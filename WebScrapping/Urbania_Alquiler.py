...
website = 'https://urbania.pe/buscar/alquiler-de-casas-o-departamentos'
...
while primera_pagina <=ultima_pagina:
    ...
    casas=container.find_elements(By.XPATH,'./div/div')
...
casas_ventas_df.to_csv('Urbania_alquiler.csv',index=False)